...
else
{
  ...
  $r6=mysqli_query($dbc, $q1);
    ...
    {
        $q1="UPDATE `favorites` SET `place` = '$place', `animal` = '$animal', `food` = '$food', `field` = '$field', `book` = '$book', `game` = '$game', `sportperson` = '$sport' WHERE `favorites`.`user_id` =$user_id";
    ...
    {
        $q2="INSERT INTO `favorites` ( `user_id`, `place`, `animal`, `food`, `field`, `book`, `game`, `sportperson`)  VALUES ($user_id, '$place',  '$animal', '$food', '$field', '$book', '$game', '$sport')";
