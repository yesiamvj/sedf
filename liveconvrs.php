...
}else
{
    ...
    $q="SELECT user_id as u,sender_id as sid ,msg as m,time as t,msg_id as mid,sender_seen as ss,msg_file as mf,msg_clr as clr,bg_color as bgc,senter_seen as sns,live as lv from messages where  delt=0 and user_id!=sender_id  and (user_id=$user_id or user_id=$my_id) and (sender_id=$user_id or sender_id=$my_id) and ((sender_seen=$my_id or senter_seen=$user_id ) or (sender_seen=$user_id or senter_seen=$my_id)) order by msg_id desc";
            ...
            $qw="select msg_file as f from msg_files where msg_id=$msg_id";
                                 ...
                                 if($rw)
                                 {
                                    ...
                                    $emp=0;
                                        ...
                                        {
                                          $emp=2;
                                            echo'<video src="'.$msg_file.'" preload="none" class="img_ConvMsgMedia" controls></video>';
                              ...
                              <div class="convMsgOutDets">
                                      <div class="convMsgOutSeen">
                                        ...
                                        echo'<font class="my_sen_img"><img class="CW_ConvMsgIcos'.$my_id.'" style="width:15px;float:left;" id="seethis'.$msg_id.'" src="../web/icons/chatwin/msg_notseen.png" /></font>';
                ...
                $(document).ready(function()
                  ...
                  // $(".CW_ConvMsgIcos'.$my_id.'").attr("src","../web/icons/msg_seen.png");
               //$(".for_delt_msgs'.$my_id.'").html("");
                   
                                        $("#seethis'.$msg_id.'").attr(\'src\',\'../web/icons/msg_seen.png\');
  ...
  echo'<script type="text/javascript">
                                          ...
                                          if($senter_seen=="0")
                                          {
                                             ...
                                             echo'$("#seethis'.$msg_id.'").attr(\'src\',\'../web/icons/msg_seen.png\');';
                                             echo'$("#for_delt_msg'.$msg_id.'").html("")';
                                          }else
                                          {
                                              
                                               echo'$("#seethis'.$msg_id.'").attr(\'src\',\'../web/icons/msg_notseen.png\');';
                                          }
                                          echo'
                                            });
                                            </script>';
     ...
     if($cnt>0)
    {
              ...
              if($senter_seen==$user_id)
             {
             	...
             	$qw="UPDATE messages set senter_seen='0',live='0' where msg_id=$msg_id";
             	$rw=mysqli_query($dbc,$qw);
                              ...
                              <div class="convMsgOutDets">
                                      ...
                                      if($senter_seen==$my_id){
                                      	echo'<font class="my_sen_img"><img class="CW_ConvMsgIcos'.$my_id.'" style="width:15px;float:left;"  width="15" height="15" id="seethis'.$msg_id.'" src="../web/icons/msg_notseen.png" /></font>';
                                      }else
                                      {
                                      	echo'<font class="my_sen_img"><img class="CW_ConvMsgIcos'.$my_id.'" style="width:15px;float:left;" id="seethis'.$msg_id.'"  width="15" height="15" src="../web/icons/chatwin/msg_seen.png" /><font class="my_sen_img">';
                                      }
                                         echo'
                                      </div>
                                      <div class="CW_Conv_MsgTimeOut"> '.$time.' </div>
