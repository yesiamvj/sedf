  ...
  ';     
    ...
    echo '
        <div id="content-full">
            ...
            <div class="pageNavItm" id="pageNavProfMemb" onclick="switchMembTabs();show_group_members('.$page_id.')" >
                    Members
                </div>
                <script>
                    function switchMembTabs(){
	  
                       if($(\'#pageProfileTab\').css(\'left\')===\'0px\'){
                           $(\'#pageProfileTab\').animate({\'left\':\'-100%\'}).hide();
                           $(\'#groupMembersTab\').show().animate({\'left\':\'0px\'});
                           $(\'#pageNavProfMemb\').text(\'Profile\');
                       }
                       else{
                            $(\'#pageProfileTab\').show().animate({\'left\':\'0px\'});
                             $(\'#groupMembersTab\').animate({\'left\':\'100%\'}).hide();
                              $(\'#pageNavProfMemb\').text(\'Members\');
                       }
                    }
                </script>
	   ...
	   if($showname=="Show")
	   {
            ...
            <div id="groupMembersTab" style="left: 100%;display: none;" >
                <div class="groupMembersOuter">
                    <div class="PGM_Ttl">
                        Members Of '.$page_name.' Group 
                        <span class="PGM_Total"> Total : 768</span>
                    </div>
