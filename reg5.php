...
<html>
  <head>
   ...
   <link type="text/css" href="reg5.css" rel="stylesheet" />
...
<script src="jquery-1.11.2.min.js" type="text/javascript"></script>
  ...
  <body ng-app="">
   ...
   <div id="steps">
          ...
          <div id="r-inps">
              <div id="r-itbls" >
                   <form method="post" action="reg5prcs.php" >
     <table >
         <tr>
             <td>
                 <h1>Favorites</h1>
...
<tr>
	...
	<td>
<input  type="text" name="plc" id="tx1" Placeholder="Favorite Place" oninput="typingel(\'#tx1\')">
	</td><td id="bv"></td>
<tr>
	<td>
            <font>Animal </font>
	...
	<td>
<input  type="text" name="anim" id="tx2" Placeholder="Favorite Animal" oninput="typingel(\'#tx2\')">
	</td><td id="bc"></td>
</tr>
<tr>
	<td><font>Food </font>
	...
	<td>
	<input type="text" name="food" id="tx3" Placeholder="Favorite Food" oninput="typingel(\'#tx3\')">
	</td><td id="cb"></td>
</tr>
<tr>
	<td><font>Field  </font>	</td>
	<td>
	<input type="text" id="tx4" name="fld" placeholder="Favorite Field" oninput="typingel(\'#tx4\')">
	</td>
	<td id="dt"></td>
</tr>
<tr>
	...
	<td>
		<input type="text" id="tx5" name="book" placeholder="Favorite Book" oninput="typingel(\'#tx5\')">
...
<tr>
	...
	<td id="gh">
            <input type="text" name="game" placeholder="Favorite Game"  id="tx6" oninput="typingel(\'#tx6\')">
	</td><td id="nw"></td>
</tr>
<tr>
	...
	<td id="gh">
            <input type="text" name="sp" placeholder="Favorite Sports Person"  id="tx7" oninput="typingel(\'#tx7\')">
	</td><td id="nw"></td>
</tr>
<tr>
	   <td><a href="reg6.php" >
