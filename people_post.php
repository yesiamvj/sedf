  <?php session_start(); 
  if(empty($_SESSION['user_id']) || empty($_SESSION['user_name']) || empty($_GET['user']))
 {
...
$people_userid=$_GET['user'];
  ...
  $users_name=$_SESSION['user_name'];
    ...
    <script src="thePost.js" type="text/javascript"></script>';
        ...
        $q="select username as u from users where user_id=$people_userid";
	   ...
	   header("location:index.php");  
	     ...
	     $owner_username=$row['u'];
               }
        }
 $p_pic='../'.$people_userid.'/ppic10.jpg';
echo ' <div class="secondaryNavTtlBar">
                      <a href="../web/people_post.php?user='.$people_userid.'"><div class="secNavToolItm">
                             Posts
                         </div></a>
                         <a href="../web/show_rels_of_pers.php?user='.$people_userid.'"><div class="secNavToolItm">
                             Relations
                         </div></a>
	       
                         <a href="../'.$owner_username.'/storage.php"><div class="secNavToolItm">
                             Storage
                         </div></a>
                         <a href="../'.$owner_username.'/photos.php"><div class="secNavToolItm">
                             Photos
                         </div></a>
                         <a href="../'.$owner_username.'/videos.php"><div class="secNavToolItm">
                             Videos
                         </div></a>
	        <a href="../'.$owner_username.'/files.php"><div class="secNavToolItm">
                             Files
                         </div></a>
                              <a href="../'.$owner_username.'/wall.php"><div class="secNavToolItm">
                             Wishes
                         </div></a>
                         
                          <a href="../'.$owner_username.'/blog.php"><div class="secNavToolItm">
                             Blog
                         </div></a>
