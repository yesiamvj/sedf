     ...
     $ucnt=0;
	     ...
	     $last_id=$_REQUEST['last_id'];
                     $qs="select post_id as u from post_permision where user_id=$user_id order by post_id desc";
                           ...
                           $q11="select rating as rt,user_id as u ,rate_time as rtm,r_seen as rs,post_status_id as ps from post_status where post_id=$post_id and rating!=0 and post_status_id between 1 and $last_id";
