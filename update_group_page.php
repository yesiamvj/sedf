    ...
    <body>
        <div id="content-full">
            <div class="pageSubTtl" id="pageSubTtlBar" style="background-color:'.$title_color.'">
                <span id="pageSubName" style="color:'.$theme.'">Update '.$page_name.' Group</span>
            </div>
            <div class="pageInnerCont">
                ...
                <div class="pageNewFrom">
                    ...
                    <div class="newPageFormItm">
                         ...
                         <div class="newPageAns">
                             <textarea id="about_page" value="'.$about_page.'" placeholder="About your Group / Organisation" >
                                                              </textarea>
                         </div>
                    </div><br/>
                     <div class="newPageFormItm">
                         <div class="newPageQue" style="display: inline" >
                             Who can post in your Group ?
                         </div>
		 ...
		 <option>'.$who_can_post.'</option>
	            ...
	            <option>'.$showname.'</option>
                    ...
                    <div class="newPageFormItm">
                         ...
                         <div class="newPageAns">
                             <input type="text" id="page_for" placeholder="This Group is Exclusively for" value="'.$page_for.'"/>
                         </div>
                    </div>
                    <div class="newPageFormItm">
                         <div class="newPageQue">
	            ...
	            <option>'.$app_style.'</option>
                    ...
                    <div id="newPageSubmit" onclick="updategroup('.$page_id.')">
                        Update Group
                    </div>
	   <div id="updt_grp_result" style="display:none;"></div>
                </div>
            </div>
        </div>
    </body>
