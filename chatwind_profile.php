                  ...
                  <div class="ChatWindowOut">
                      ...
                      <div class="ChatWindTtl" style="background-color: '.$theme.'"  >
                          ...
                          <div class="ChWin_Tools" style="background-color: '.$theme.'" >
                              ...
                              <div class="ChWin_Close" onclick="$(\'#on_lives_convrse'.$my_id.'\').val(\'0\');$(\'#chat_user_window\').fadeToggle();">X<input type="hidden" id="chwnusrcnt" value="'.$cnt.'" /></div>
                          </div>
                      </div>
  ...
  <script type="text/javascript">
   ...
   var cont="q="+'.$my_id.'+"&cnt="+'.$cnt.';
      var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("post", "../web/liveconvrs.php?"+cont, true);
        xmlhttp.send(); 
...
$(\'#sendmsg'.$my_id.'\').click();
            ...
            ';
                      $q="SELECT user_id as u,msg as m,time as t,msg_id as mid,msg_file as mf,msg_clr as clr,bg_color as bgc,day as d,senter_seen as sns from messages where  delt=0 and sender_id!=user_id  and (user_id=$user_id or user_id=$my_id) and (sender_id=$user_id or sender_id=$my_id) and senter_seen!=$user_id  order by msg_id desc limit 10";
                      $r=mysqli_query($dbc,$q);
                      if($r)
                      {
                        if(mysqli_num_rows($r)>0)
