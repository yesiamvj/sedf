    ...
    }else
    {
        $w_pic="";
		         ...
		         if($rpage)
		         {
		                ...
		                {
			      $row=  mysqli_fetch_array($rpage,MYSQLI_ASSOC);
			      $page_name=$row['p'];
		                }else
		                {
            ...
            <div class="TheWhatsUp" >
              <div class="whatsUpWelcomer">
                    <div class="WUW_wallPic" style="background-image: url(\''.$w_pic.'\');" >
                        <img class="WUW_ProfPic" src="../pages/'.$page_id.'/ppic25.jpg" /> 
                            <div class="WUW_signature"> $'.$page_name.'
                            </div>
                    </div>
                  
                </div>';
        $prof_pic='../'.$page_name.'/ppic25.jpg';
                        ...
                        <div class="ThePostToppper">
                           <div class="ThePostOwner">
                            <div class="PosterProfPic">
                                <img src="../'.$page_name.'/ppic25.jpg" class="img_PosterFace" alt=""/>
                            </div>
                            <div class="PosterName">
                                <a href="../'.$page_name.'" class="PosterUserLink" >  '.$page_name.'</a> 
                               <div class="PosterSignature" title="Page ID : '.$page_id.'" > <a href="http://www.sedfed.com/'.$page_name.'"> <span class="sf_TmDoller" >$</span>'.$page_name.'</a></div> 
...
$ratc=0;
	     ...
	     $seen_cnt=0;
             ...
             }else
             {
                    ...
                    $aps="SELECT post_id as pid,user_id as uid,allpeople as ap,share as shr,page_id as p,officiale as of_cl from post_permision where page_id=$page_id and  allpeople=$allppl and allrelation=$allrel order by post_id desc ";
