   ...
   }else
   {
	     ...
	     $last_id=$_REQUEST['last_id'];
                     ...
                     $q="select post_id as u from post_permision where user_id=$user_id";
                           ...
                           $q11="select post_status_id as psid,like_userid as lk ,unlike_userid as un,like_time as t,rating as rt from post_status where post_id=$post_id and like_userid!=0 and post_status_id between 1 and $last_id order by post_status_id desc limit 25";
