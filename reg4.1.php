...
<script src="jquery-1.11.2.min.js" type="text/javascript"></script>
  ...
  <body ng-app="">
   ...
   <div id="steps">
          ...
          <div id="r-inps">
              <div id="r-itbls" >
                   <form method="post" action="reg4.1prcs.php" >
     <table >
         <tr>
             <td>
                 <h1>Annoyings</h1>
...
<tr>
	...
	<td>
<input onclick="instruct(16)" type="number" name="numb" id="tx1" oninput="typingel(\'#tx3\')" Placeholder="Annoying Number">
	</td><td id="bv"></td>
</tr>
	...
	<td><font>Letter </font> 
        ...
        <td>
            <input   type="text" name="l" id="tx2" oninput="typingel(\'#tx2\')" Placeholder="Annoying Letter">
	</td><td id="ab"></td>
...
<tr>
	...
	<td>
<input  type="text" name="c" id="tx3" Placeholder="Annoying color" oninput="typingel(\'#tx3\')">
	</td><td id="bc"></td>
</tr>
<tr>
	<td><font>Actor </font>
	...
	<td>
		<input type="text" name="a" id="tx4" oninput="typingel(\'#tx4\')" Placeholder="Annoying Actor">
	</td><td id="cb"></td>
</tr>
<tr>
	<td><font>Actress   </font>	</td>
	<td>
            <input type="text" id="tx5" name="act" oninput="typingel(\'#tx5\')" placeholder="Annoying Actress">
	</td>
	<td id="dt"></td>
</tr>
<tr>
	...
	<td>
		<input type="text" id="tx6" name="m" oninput="typingel(\'#tx3\')" placeholder="Annoying Movie">
...
<tr>
	...
	<td id="gh">
            <input type="text" name="sora" placeholder="Annoying Song or Album"  id="tx7" oninput="typingel(\'#tx7\')"/>
	</td><td id="nw"></td>
</tr>
<tr>
    <td><a href="reg4.2.php" >
