...
}else
{
 ...
 function people($username,$user_id,$f_name,$age,$times,$np,$posi,$sex,$n,$email,$mobno,$clg,$bldgrop,$status,$cur_loc,$scl,$hscl,$mysts,$mytype,$mycnct,$myuser,$p_pic)
{
      if($sex=="boy")
      {
          $sex="Male";
        ...
        }else
        {
            echo'<div class="respItm" id="acreqbtn'.$n.'"  onclick="addtorels(\''.$username.'\',\''.$f_name.'\')">
                         ...
                         <!--  <div class="pplNamey" id="hfname'.$n.'">'.$f_name.'</div> -->
                            ...
                            ">
                                <div class="pplFace">
                                    <img class="profImg" src="profileimg.PNG" alt="'.$f_name.'" />
                                </div>
                                <div class="pplDets">
...
function namesonly($username,$user_id,$f_name,$age,$times,$np,$posi,$sex,$n,$email,$mobno,$clg,$bldgrop,$status,$cur_loc,$scl,$hscl,$mysts,$mytype,$mycnct,$myuser,$p_pic)
{
    if($sex=="boy")
      {
          $sex="Male";
    ...
    echo' <font id="trgtdiv'.$n.'">
             <input type="hidden" value="'.$f_name.'" id="hfname'.$n.'" />
	<input type="hidden" value="'.$age.'" id="hage'.$n.'" />
    		<input type="hidden" value="'.$times.'" id="verified_time'.$n.'" /><div class="NameTypeOut">
...
function expandedtiles($username,$user_id,$f_name,$age,$times,$np,$posi,$sex,$n,$email,$mobno,$clg,$bldgrop,$status,$cur_loc,$scl,$hscl,$mysts,$mytype,$mycnct,$myuser,$p_pic)
{
    if($sex=="boy")
      {
          $sex="Male";
 ...
 $qc="select cu_id as cid,c_name as c ,type as tp from contacts where user_id=$user_id ";
...
if($rtype)
{
    if(mysqli_num_rows($rtype)>0)
    {
                ...
                if($mytpe==1)
                {
                    namesonly($username,$user_id,$f_name,$age,$times,$np,$posi,$sex,$n,$email,$mobno,$clg,$bldgrop,$status,$cur_loc,$scl,$hscl,$mysts,$mytype,$mycnct,$myuser,$p_pic);

                }
                if($mytpe==2)
                {
                     people($username,$user_id,$f_name,$age,$times,$np,$posi,$sex,$n,$email,$mobno,$clg,$bldgrop,$status,$cur_loc,$scl,$hscl,$mysts,$mytype,$mycnct,$myuser,$p_pic);
                ...
                if($mytpe==4)
                {
                     expandedtiles($username,$user_id,$f_name,$age,$times,$np,$posi,$sex,$n,$email,$mobno,$clg,$bldgrop,$status,$cur_loc,$scl,$hscl,$mysts,$mytype,$mycnct,$myuser,$p_pic);
