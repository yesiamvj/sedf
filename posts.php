                        ...
                        <div class="ThePostToppper">
                           <div class="ThePostOwner">
                            ...
                            <div class="newPostSubmitter">
                                 <div class="newPostedNext" onclick="open_new_post();$(\'#NpPostCaptionContTxt\').val($(\'#WNPASU_TextEditor\').val());$(\'.CreateNewPostBackG\').slideDown();$(\'.CNPH_finalCont\').fadeOut();$(\'.CNPH_StepOneHolder\').fadeIn();">
                                Post
                            </div>
                            </div>
