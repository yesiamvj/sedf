...
<html>
   ...
   <script src="createpage.js" type="text/javascript"></script>
    ...
    <body>
        <div id="content-full">
        <form method="post" action="createpage_prcs.php" enctype="multipart/form-data">
            <div class="pageSubTtl" id="pageSubTtlBar" >
                <span id="pageSubName">Create New Page</span>
            </div>
            <div class="pageInnerCont">
                ...
                <div class="pageNewFrom">
                    <div class="newPageFormItm">
                         ...
                         <div class="newPageAns">
                             <input type="text" name="page_name" oninput="check_pagename(this.value);fillTtlBar()"   placeholder="Your new page name" />
                             <script>
                                 function fillTtlBar(){
                                     if($(\'#pageName\').val()===\'\'){
	            ...
	            <span id="username_relst"></span>
                    ...
                    <div class="newPageFormItm">
                        ...
                        <div class="newPageAns" >
                            Title Bar Color
                            <div class="colorInpBtns" style="display:inline-block;" id="ttlBarClr" onclick="$(\'#myOrgThme\').click();"  >
                                Choose color
                            </div>
                            Title Color
                            <div class="colorInpBtns" style="display:inline-block;" id="ttlTextClr" onclick="$(\'#myTextClr\').click();" >
                                Choose Title Color
                            </div>
                         </div>
                        
                        <input type="color" id="myOrgThme" name="title_bar_clr" oninput="$(\'#pageSubTtlBar\').css({\'background-color\':$(\'#myOrgThme\').val()});" onchange="$(\'#pageSubTtlBar\').css({\'background-color\':$(\'#myOrgThme\').val()});" style="display: none" />
                        <input type="color" id="myTextClr" name="txt_clr" oninput="$(\'#pageSubName\').css({\'color\':$(\'#myTextClr\').val()});" onchange="$(\'#pageSubName\').css({\'color\':$(\'#myTextClr\').val()});" style="display: none" />
                    </div>
                    ...
                    <div class="newPageFormItm">
                         ...
                         <div class="newPageAns">
                             <input type="text" name="page_website" placeholder="Your new page name" />
                         </div>
                    </div>
                    <div class="newPageFormItm">
                         <div class="newPageQue">
                    ...
                    <div class="newPageFormItm">
                         ...
                         <div class="newPageAns">
                             <input type="text" name="page_for" placeholder="This page is Exclusively for" />
                         </div>
                    </div>
                    <div class="newPageFormItm">
                         <div class="newPageQue">
                    ...
                    <input type="submit" value="Create Page" id="newPageSubmit" >
                        
                    </div>
	   </form>
                </div>
            </div>
            <div id="result_page_div"></div>
        </div>
    </body>
</html>
';
