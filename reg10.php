...
<html>
  <head>
   ...
   <link type="text/css" href="reg10.css" rel="stylesheet" />
...
<script src="jquery-1.11.2.min.js" type="text/javascript"></script>
  ...
  <body ng-app="">
   ...
   <div id="steps">
              <ul id="stps">
                  ...
                  <li>Annoying</li>
                  <li>About</li>
                  <li id="curstep">Status</li>
              </ul>
          </div>
          <div id="r-inps">
              <div id="r-itbls" >
                   <form method="post" action="reg10prcs.php" >   
     <table>
          <tr>
             <td>
                 <h1>Status</h1>
 ...
 <tr>
	...
	<td>
<input type="text" name="curstatus" id="tx1" oninput="typingel(\'#tx1\')" Placeholder="Status now">
	</td><td id="bv"></td>
</tr>
<tr>
	<td><font>About Me </font>
	</td>
	<td>
<input  type="text" name="aboutme" id="tx2" oninput="typingel(\'#tx2\')" Placeholder="About You">
	</td><td id="bc"></td>
</tr>

<tr>
	<td><font>Some Words to World </font>	</td>
	<td>
	<input type="text" name="wtow" id="tx3" oninput="typingel(\'#tx3\')" placeholder="About World">
	</td>
	<td id="dt"></td>
</tr>
<tr>
	...
	<td align="right">
	<input type="submit" id="next" value="Finish">
