	...
	<input type="hidden" value="'.$age.'" id="hage'.$n.'" />
         ...
         <div class="pplItemOut" >
                            <div class="PplRespOut">
                                    <div class="pplRespIn">
                                        <div class="respItm" id="acreqbtn'.$n.'" onclick="showcmnrels(\''.$username.'\',\''.$f_name.'\');$(\'#switch_tiles\').val(41);" >
                                             View Common Relations</div>
	...
	<input type="hidden" value="'.$age.'" id="hage'.$n.'" />
         ...
         <div class="NameTypeOut">
                            ...
                            <div class="NmeTypIn">
                                ...
                                <div class="NmeTypItm">
                                <div class="pplDetItm" >'.$mytype.'</div>
                                    <div class="pplDetItm">'.$age.'<sub>+</sub><span class="divider"> | </span> '.$sex.' <span class="divider"> | </span><span class="divider">  </div>
                                                    '.$cmr.' people in common                                
                                                   </div>
                            </div>
                        </div></font>';
...
function expandedtiles($username,$f_name,$age,$times,$np,$posi,$sex,$n,$email,$mobno,$clg,$bldgrop,$status,$cur_loc,$scl,$hscl,$mysts,$mytype,$cmr,$p_pic,$my_cncts)
{
    ...
    <div class="BigpplItemOut">
                             <div class="PplRespOut">
                                    <div class="pplRespIn">
                                      <div class="respItm" id="acreqbtn'.$n.'" onclick="showcmnrels(\''.$username.'\',\''.$f_name.'\')" >
                                                View Common Relations
                                                </div>
                                        <a href="../'.$username.'" id="husrnm'.$n.'">
                                        <div class="respItm">
