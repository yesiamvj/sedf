...
<script src="jquery-1.11.2.min.js" type="text/javascript"></script>
  ...
  <body ng-app="">
   ...
   <div id="steps">
          ...
          <div id="r-inps">
              <div id="r-itbls" >
                   <form method="post" action="reg9prcs.php" >   
     <table>
          <tr>
             <td>
                 <h1>About</h1>
...
<tr>
	...
	<td>
<input  type="text" name="paiyan" id="tx1" oninput="typingel(\'#tx1\')" Placeholder="About Boys" >
	</td><td id="bv"></td>
</tr>
	...
	<td><font>Girls</font> 
        ...
        <td>
            <input   type="text" name="pon" id="tx2" oninput="typingel(\'#tx2\')" Placeholder="About Girls">
	</td><td id="ab"></td>


<tr>
	<td><font>Marriage </font>
	</td>
	<td>
<input  type="text" name="marig" id="tx3" oninput="typingel(\'#tx7\')" Placeholder="About Marriage">
	</td><td id="bc"></td>
</tr>
<tr>
	<td><font>My College<font>
	</td>
	<td>
	<input  type="text" name="clg" id="tx4" oninput="typingel(\'#tx4\')" Placeholder="About My College">
	</td>
        <td id="cb"></td>
</tr>
<tr>
	<td><font>Teachers </font>	</td>
	<td>
	<input type="text" name="tchr" id="tx5" oninput="typingel(\'#tx5\')" placeholder="About Teachers">
	</td>
	<td id="dt"></td>
</tr>
<tr>
	...
	<td>
		<input type="text" name="enter" id="tx6" oninput="typingel(\'#tx7\')" placeholder="About Entertainment">
...
<tr>
	...
	<td id="gh">
            <input type="text" name="sf" placeholder="About SedFed"  id="tx7" oninput="typingel(\'#tx7\')"/>
	</td><td id="nw"></td>
</tr>
  </table>
                      
     <input class="addn" id="addn" type="button" value="Add About" onclick="addabt(3)"><br/><br/>
<table>
<tr>
        <td><a href="reg10.php" >
