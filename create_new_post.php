...
}else
{
    ...
    require_once 'mysqli_connect.php';
        $ppics='../'.$_SESSION['user_name'].'/ppic10.jpg';
    echo '<!DOCTYPE html>
...
<html>
    ...
    <link rel="stylesheet" href="'.$_SESSION['css'].'createNewPost.css"/>
   ...
   <script src="jquery.MetaData.js" type="text/javascript"></script>
    ...
    <body>
        <div class="contentFull">
            ...
            <div class="CreateNewPostHolder">
                <div class="CNPH_Ttl">Create a new Post <div class="CNPH_S1Ttl">
                    ...
                    <div class="closeCreateNewPost" onclick="$(\'#for_create_post\').slideUp()" >X</div>
                </div>
                ...
                <form method="post" id="upload_form" onsubmit="show_prbar(event);return true;" action="uploadpostcon.php" enctype="multipart/form-data" target="published_post">
                ...
                <div class="CNPH_StepOneHolder" style="//display: none" >
                    ...
                    <div class="CNPH_S1_Cont">
                        ...
                        <textarea placeholder="Hey , What\'s Up ?" id="NpPostCaptionContTxt" ></textarea>
                        ...
                        <div class="CNPH_CapColors">
                            ...
                            <input onchange="CrNwPostSetClrChnge(\'caption\',\'#NpSetPC-txtclrinp\',\'#NpSetPC-txtclr\',\'c\')" id="NpSetPC-txtclrinp" name="cap_color" type="color" value="navy" style="width:0px;height:0px;"/>
                            <div class="CNPH_CapColorItm" id="NpSetPC-txtBGclr" onclick="document.getElementById(\'NpSetPC-txtBGclrinp\').click()">
                                Background Color
                            </div>
                            <input onchange="CrNwPostSetClrChnge(\'caption\',\'#NpSetPC-txtBGclrinp\',\'#NpSetPC-txtBGclr\',\'bg\')" id="NpSetPC-txtBGclrinp" name="cap_back_color" value="#ffffff" type="color" style="display: none;"/>
                        </div>
                          <div class="CNPH_CapTip">
                            Use \' $ \'  symbol to Tag or specify a person . You can use \' # \' Tags .
                        </div>
                         <div id="NppostAdditionals">
                                        <div id="NpFeelExpDiv" class="NpP_A_Exp_Item" onclick="NewPostExpand(\'#NpFeelCont\',\'#NpFeelExpDiv\')"><img class="NewPostFeelingicon" src="icons/test-smiley.png" /> Action</div>
                                         <div id="NpLocExpDiv" class="NpP_A_Exp_Item" onclick="NewPostExpand(\'#NpLocateCont\',\'#NpLocExpDiv\')"><img class="NewPostFeelingicon" src="icons/location.png"/>Location</div>
                                          <div id="NpWithExpDiv" class="NpP_A_Exp_Item" onclick="NewPostExpand(\'#NpWithCont\',\'#NpWithExpDiv\')"><img class="NewPostFeelingiconp" src="icons/with_people.png"/>People</div>
                                        <div class="NpP_A_FeelCont" id="NpFeelCont" style="display: none;">
                                            <div id="NpP_A_Item">While Posting <input name="NpFeelWhileInp" type="text" placeholder="What do you feeling/Doing now..."/> </div>
                                            <div id="NpP_A_Item">By Posting &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="NpFeelByInp" type="text" placeholder="Feeling/Doing by posting this..."/></div>
                                        </div>
                                          <div class="NpP_A_FeelCont" id="NpLocateCont" style="display: none;">
                                            <div id="NpP_A_Item">Where ?<input name="NpLocateInp" type="text" placeholder="In Location"/> </div>
                                          </div>
	   ...
	   <input type="hidden" value="1" id="my_cur_val" />
                            ...
                            <div id="NpAdvOuter">
                                <div class="heplll" onclick="$(\'#NpAdvhelpWindow\').slideDown();" style="cursor: pointer;float: right" >? help</div> 
                                    <div id="NpAdv-Caption">
                                        ...
                                        <textarea id="NpAdv-Editor-inp" name="orig_post_cap" placeholder="About This Post" oninput="$(\'#NpAdvPreview-Main\').html($(\'#NpAdv-Editor-inp\').val());"></textarea>
                            ...
                            <div id="NpAdvhelpWindow">
                                ...
                                <div class="CNPH_S2_Cont" style="display: none;" >
                                    ...
                                    <script>
                                     ...
                                     <input type="file" id="myfiles_id" name="myfiles" onchange="clear_imgs(this)" style="width:0px;height:0px;"/>
		  ...
		  <div class="CNPH_Add_Btn"  onclick="$(\'#myfiles_id\').click();">
                                    ...
                                    <input type="file" name="myfile" onchange="$(\'#commonFileName\').text($(\'#commonFileInput\').val())" style="position:fixed;top: -5000px;width: 0px;height: 0px;" name="commonFile" id="commonFileInput" />
                                    ...
                                    <div class="videoThumbnailHolder" style="display: none" >
                                        ...
                                        <div class="CNPH_Video_File" onclick="$(\'#myfiles_id\').click();">
                                            Browse
                                        </div>
                                        ...
                                        <br/>
		      <div>
                                        <input type="file"  name="thumb_nail" id="thumb_nail_id" style="display:none"  accept="gif|jpg|png|jpeg"/>
                                    </div>
		        </div>
		  ...
		  <input type="hidden" value="50" id="jpeg_encode_quality" />
                                       ...
                                       Compression Quality     <input type="range" onchange="$(\'#NPC_QSildeinp\').val(this.value)" id="imgCompressScale" />
                                        ...
                                        <div class="compressImgBtn" onclick="$(\'#for_tot_file_size\').val(\'0\');nowcompress();">
                                            Compress
                                        </div><span id="NPCQ_FileSize"></span>
                                     </div>
                                    <div class="CNPH_Drivers">
                                        ...
                                        Who can see this post ?
                                           ...
                                           <input type="hidden" id="chkalrdclkd" value="1"/>
                                            <div id="NPWCaudiCont" style="text-align: center;//display: none">
                                                <div class="NPWCAitem">
                                                    <input type="checkbox" value="1" onclick="pt_resp(this.id)" id="incl_me" checked name="include_me"/> Me
                                                </div>
                                                <div class="NPWCAitem">
                                                    <input type="checkbox" checked="checked" value="1" id="all_rels" onclick="pt_resp(this.id)" name="allrlns"/> All Relations
                                                </div>
                                                <div class="NPWCAitem">
                                                    <input type="checkbox" checked="checked" id="post_pers1"  value="1" name="show_to_user"  onclick="open_add_ppl_wind(2);$(\'#NPWCaudiInpSho\').slideToggle();pt_resp(this.id);"  /> Show to
                                                </div>
		          
                                                <div class="NPWCAitem">
                                                    <input type="checkbox" checked="checked" id="post_pers2" value="1" name="hide_to_user"  onclick="open_add_ppl_wind(3);$(\'#NPWCaudiInpHid\').slideToggle();pt_resp(this.id)"/> Hide To
                                                </div>
                                        ...
                                        What can people do to this post ?
                                         ...
                                         <div id="NPWCrespCont"  >
                                                <div id="NPWC-innerResp">
                                                    ...
                                                    <input type="checkbox" onclick="pt_resp(this.id)" id="ppl_resp1" value="1" name="resp1" checked/>  <img   class="NPSlikeicon" src="icons/post-sf-like.png" alt="like"/> 
                                                    <input type="checkbox" onclick="pt_resp(this.id)" id="ppl_resp2" value="1" name="resp2" checked/><img  id="Np-unlikeIcon" class="NPSlikeicon" src="icons/post-sf-unlike.png" alt="like"/> 

                                                    <input type="checkbox" onclick="pt_resp(this.id)" id="ppl_resp3" value="1" name="resp3" checked/>    <img     class="NPSlikeicon" src="icons/post-sf-emptyRate.png" alt="like"/>



                                                    <input type="checkbox" onclick="pt_resp(this.id)" id="ppl_resp4" value="1" name="resp4" checked/>     <img src="icons/post-media-download.png"  class="NPSlikeicon"/>&nbsp;&nbsp;
                                                    <input type="checkbox" onclick="pt_resp(this.id)" id="ppl_resp5" value="1" name="resp5" checked/>   <img class="NPSlikeicon" src="icons/post-sf-comment.png" alt="like"/>
                                                    <input type="checkbox" onclick="pt_resp(this.id)" id="ppl_resp6" value="1" name="resp6" checked/>    <img class="NPSlikeicon"   src="icons/post-sf-share.png" alt="like" width="23px" height="23px"/>
		  ...
		  <div id="comp_images"><input type="hidden" value="" name="com_img_src[]" id="compressed_img" /></div>
            
		  <input type="submit" class="postUploadBtn" onclick="swichNextTab(\'5\',\'.CNPH_finalCont\',\'.CNPH_S3_Cont\');" value="Publish" />
	               ...
	               <iframe src=" width="0" height="0" name="published_post"/></iframe>
                                <script>
