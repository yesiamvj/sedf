...
}else
{
       ...
       $q="select msg_id as mid,sender_id as u,seen as sn,msg as m ,msg_clr as mc,bg_color as bgc,time as tm,senter_seen as sn from messages where user_id=$user_id and delt=0 order by msg_id desc limit 25";
       $r=  mysqli_query($dbc, $q);
       if($r)
       {
              $n=0;
