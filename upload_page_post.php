<?php session_start();
   ...
   $post_loc=mysqli_real_escape_string($dbc,$_REQUEST['NpLocateInp']);
    ...
    echo 'alll rels id '.$allrel.'';
     $post_cap=mysqli_real_escape_string($dbc,$_REQUEST['NpAdv-Editor-inp']);
     $friends=0;
     $family=0;
     $special=0;
     $enemy=0;
     ...
     $cap_bg_clr=mysqli_real_escape_string($dbc,$_REQUEST['NpSetPC-txtBGclrinp']);
     $txt_clr=mysqli_real_escape_string($dbc,$_REQUEST['NpSetPC-txtclrinp']);
     $wp_brdr_color="";
     $wp_txt_bg_clr="";
     $like=$_REQUEST['resp1'];
     ...
     $today = date("g:i a ,F j, Y"); 
       $ipp="INSERT INTO `post_permision` ( `user_id`, `allpeople`, `allrelation`,page_id,me) VALUES ( '$user_id', '$all_ppl', '$allrel', $page_id,$me)";
