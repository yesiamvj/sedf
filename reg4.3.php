...
<script src="jquery-1.11.2.min.js" type="text/javascript"></script>
  ...
  <body ng-app="">
   ...
   <div id="steps">
          ...
          <div id="r-inps">
              <div id="r-itbls" >
                   <form method="post" action="reg4.3prcs.php" >
     <table>
          <tr>
             <td>
                 <h1>Annoyings</h1>
...
<tr>
	...
	<td>
<input type="text" name="authr" id="tx1" oninput="typingel(\'#tx1\')" Placeholder="Annoying Author">
	</td><td id="bv"></td>
</tr>
	...
	<td><font>TV show </font> 
        ...
        <td>
            <input   type="text" name="tvsh" id="tx2" oninput="typingel(\'#tx2\')" Placeholder="Annoying Show">
	</td><td id="ab"></td>
...
<tr>
	...
	<td>
<input  type="text" name="cn" id="tx3" oninput="typingel(\'#tx3\')" Placeholder="Annoying Cartoon">
	</td><td id="bc"></td>
</tr>
<tr>
	...
	<td>
	<input  type="text" name="mscdir" id="tx4" oninput="typingel(\'#tx4\')" Placeholder="Annoying Music Director">
	</td>
        <td id="cb"></td>
</tr>
<tr>
	...
	<td>
            <input type="text" name="flmdir" id="tx5" oninput="typingel(\'#tx2\')" placeholder="Annoying Film Director">
	</td>
	<td id="dt"></td>
</tr>
<tr>
	...
	<td>
            <input type="text" id="tx6" name="cmdyact" oninput="typingel(\'#tx2\')" placeholder="Annoying Comedy Actor">
...
<input class="addn" id="addn" type="button" value="Add Annoying" onclick="addnew(3)"><br/><br/>
<table>
    <tr>
	  <td><a href="reg8.php" >
