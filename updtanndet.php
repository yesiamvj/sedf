...
else
{
   ...
   $fr20=mysqli_real_escape_string($dbc,$_REQUEST['fr20']);
     $q2="select annoy_id as f from annoying where user_id=$user_id";
   ...
   $q="INSERT INTO `annoying` ( `user_id`, `number`, `letter`, `color`, `actor`, `actress`, `movie`, `sora`, `place`, `animal`, `food`, `field`, `book`, `game`, `sportperson`, `author`, `tvshow`, `cn`, `miscdir`, `filmdir`, `cmdyactr`) VALUES ($user_id , '$f1','$f2','$f3', '$f4', '$f5', '$f6', '$f7', '$f8', '$f9', '$f10', '$f11', '$f12', '$f13', '$f14', '$f15', '$f16', '$f17', '$f18', '$f19', '$f20')";
   $r=mysqli_query($dbc,$q);
   if($r)
   {
      echo "ins fav";
                        $q3="DELETE FROM `annoying` WHERE  annoy_id=$favid";
   ...
   }else
   {
     ...
     $q4="select annoy_id as f from annoy_reason where user_id=$user_id";
   ...
   if($r4)
   {
      ...
      {
         $favid=$rows['f'];
         $q1="INSERT INTO annoy_reason (`user_id`, `number`, `letter`, `color`, `actor`, `actress`, `movie`, `sora`, `place`, `animal`, `food`, `field`, `book`, `game`, `sportperson`, `author`, `tvshow`, `cn`, `miscdir`, `filmdir`, `cmdyactr`) VALUES ($user_id , '$fr1','$fr2','$fr3', '$fr4', '$fr5', '$fr6', '$fr7', '$fr8', '$fr9', '$fr10', '$fr11', '$fr12', '$fr13', '$fr14', '$fr15', '$fr16', '$fr17', '$fr18', '$fr19', '$fr20')";
   $r1=mysqli_query($dbc,$q1);
   if($r1)
   {
      echo "ins fav res";
                     $q3="DELETE FROM `annoy_reason` WHERE  annoy_id=$favid";
                  $r3=mysqli_query($dbc,$q3);
                  if($r3)
                  {
                     echo "dlt";
