...
}else
{
       ...
       $q="select msg_id as mid,sender_id as u,seen as sn,msg as m ,msg_clr as mc,bg_color as bgc,time as tm from messages where  msg_id!=$last_id and msg_id between   $initial_msg_id and $last_id and user_id=$user_id and delt=1  order by msg_id desc limit 25";
