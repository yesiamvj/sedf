...
}else
{
       ...
       $q="select msg_id as mid,user_id as u,msg as m ,msg_clr as mc,bg_color as bgc,time as tm,senter_seen as sn from messages where sender_id=$user_id and delt=0 order by msg_id desc limit 25";
       $r=  mysqli_query($dbc, $q);
       if($r)
       {
              $n=0;
