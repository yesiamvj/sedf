           ...
           echo '<div class="pageTtlBar">
            ...
            <div class="pageIdBigDets" style="display: none;" >
                <div class="pageAddressItm">
                    sedfed.com/'.$page_name.'
                </div>
                <div class="pageAddressItm">
                    sedfed.com/pages/'.$page_id.'
                </div>
            </div>
            ...
            <div class="pageStaticContent">
                ...
                <div class="pageAboutBottom">
                    <div class="pageAboutItm">
                        Page Admin <span class="PA_Ans">'.$admin_name.'</span>
                    </div>
                    <div class="pageAboutItm">
                    ...
                    <div class="pageAboutItm">
                        Page Address  <a href="../'.$page_name.'"><span class="PA_Ans">sedfed.com/'.$page_name.'</span></a>  or <a href="../pages/'.$page_id.'"><span class="PA_Ans">sedfed.com/pages/'.$page_id.'</span></a>
                    </div>
