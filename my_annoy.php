...
}else
{
    ...
    mysqli_query($dbc, $q);
     $q="select annoying as g from profile_sets where user_id=$user_id";
    $r=  mysqli_query($dbc, $q);
    if($r)
    {
           if(mysqli_num_rows($r)>0)
        ...
        <div id="content-full">
              ...
              <div class="myCurrentInfoOut" id="myEducation" >
                          ...
                          <div class="privacyOuter">
                              ...
                              <select onchange="change_prof_privacy(\'annoying\',this.value)">
...
<div class="profTypeTitle">Annoyings</div>
<!--  <div id="profTypeTitle">Current <div id="amIalive" style="color:green">  offline</div></div> -->
...
<br/>
                                  ...
                                  <div class="pageBottomProceeds">
                                    <a href="gadgets.php"> <div class="updateHolder"  id="skipBtn" >Skip</div></a>
                               <div class="updateHolder"  onclick="updtanndet()" id="nextBtn">Next</div>
                                </div>
