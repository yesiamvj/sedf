  ...
  $users_name=$_SESSION['user_name'];
    ...
    <script src="thePost.js" type="text/javascript"></script>';
        ...
        require_once  'mysqli_connect.php';
	            ...
	            $w_pic='../'.$_SESSION['user_name'].'/wpic50.jpg';
	            
                         $q2="SELECT first_name as fn,nick_name as nck,age as ag,nativeplace as np,sex as s from basic where user_id=$user_id";
				...
				$sex=$row['s'];
								}else
								{
								       ...
								       $first_name="";
                                                ...
                                                $ppics='../'.$_SESSION['user_name'].'/ppic25.jpg';         
        ...
        echo '<div id="content-full">
            ...
            <div class="TheWhatsUp" >
              <div class="whatsUpWelcomer">
                    <div class="WUW_wallPic" style="background-image: url(\''.$w_pic.'\');" >
                        <img class="WUW_ProfPic" src="'.$ppics.'" /> 
                            <div class="WUW_signature"> $'.$users_name.'
                            </div>
                    </div>
                    <div class="WUW_ImpLinks">
                    <a href="edit_current.php" target="_blank">
                        <div class="WUW_LinkItm" style="color:darkorange" >
                            Update your status 
                        </div>
                        </a>
                        <a href="../'.$users_name.'/blog.php" target="_blank">
                        <div class="WUW_LinkItm" style="color:darkmagenta" >
                            Update your blog
                        </div>
                        </a>
                        ...
                        <div class="ThePostToppper">
                           <div class="ThePostOwner">
                            <div class="PosterProfPic">
                                <img src="'.$ppics.'" class="img_PosterFace" alt=""/>
                            </div>
                            <div class="PosterName">
                                <a href="../'.$users_name.'" class="PosterUserLink" >  '.$first_name.' </a> 
                            ...
                            <div class="ThePostCaption" id="newPostCapterHolder" >
                            
                            <textarea class="newPostTxtx" id="WNPASU_TextEditor" placeholder="Hey , What\'s Up ? "  ></textarea>
                            
                        </div> 
                            <div class="newPostSubmitter">
                                 <div class="newPostedNext" onclick="$(\'#for_create_post\').fadeIn();$(\'#NpPostCaptionContTxt\').val($(\'#WNPASU_TextEditor\').val());$(\'.CreateNewPostBackG\').slideDown();$(\'.CNPH_finalCont\').fadeOut();$(\'.CNPH_StepOneHolder\').fadeIn();">
                                Post
                            </div>
                            </div>
	  ...
	  if($likeres==1)
	         ...
	         echo '<div class="TPSH_Itm">';
                        if($mylike==1)
                        {
                            ...
                            echo '<img class="ico_PostResp" onclick="Likedone(1,\'#like'.$cnt.'\','.$post_id.','.$cnt.',2,this,'.($pers_like-1).')"   id="like_1_icon_'.$cnt.'" src="icons/post-sf-liked.png" style="display:none;" alt="like"/> ';
                           echo '<img class="ico_PostResp" onclick="Likedone(1,\'#like'.$cnt.'\','.$post_id.','.$cnt.',2,this,'.($pers_like-1).')"  id="like_2_icon_'.$cnt.'" src="icons/post-sf-liked.png" alt="like"/><span class="pers_like'.$cnt.'" id="mainLikecnt_'.$cnt.'" >'.$pers_like.'</span> ';
                           
                        }else
                        {
                        echo '<img class="ico_PostResp" onclick="Likedone(1,\'#like'.$cnt.'\','.$post_id.','.$cnt.',2,this,'.$pers_like.')"  id="like_1_icon_'.$cnt.'" src="icons/post-sf-like.png" alt="like"/> ';
	       echo '<img class="ico_PostResp" onclick="Likedone(1,\'#like'.$cnt.'\','.$post_id.','.$cnt.',2,this,'.$pers_like.')"  id="like_2_icon_'.$cnt.'" src="icons/post-sf-liked.png" style="display:none;" alt="like"/> <span class="pers_like'.$cnt.'" id="mainLikecnt_'.$cnt.'">'.$pers_like.'</span>  ';
	       ...
	       echo '<div class="TPSH_Itm">';
                        ...
                        if($myunlike==1)
                        {
                            ...
                            echo' <img class="ico_PostResp" onclick="Likedone(0,\'#unlike'.$cnt.'\','.$post_id.','.$cnt.',2,this,'.($pers_unlike-1).')"  id="un_1_like'.$cnt.'" src="icons/post-sf-unliked.png" style="display:none;" alt="Unlike"/>';
                             echo' <img class="ico_PostResp" onclick="Likedone(0,\'#unlike'.$cnt.'\','.$post_id.','.$cnt.',2,this,'.($pers_unlike-1).')"  id="un_2_like'.$cnt.'" src="icons/post-sf-unliked.png" alt="Unlike"/>&nbsp;&nbsp;<span class="pers_unlike'.$cnt.'" id="mainunLikecnt_'.$cnt.'">'.$pers_unlike.'</span> ';
                            
                        }else
                        {
                            
                            echo' <img class="ico_PostResp" onclick="Likedone(0,\'#unlike'.$cnt.'\','.$post_id.','.$cnt.',2,this,'.$pers_unlike.')"  id="un_1_like'.$cnt.'" src="icons/post-sf-unlike.png"  alt="Unlike"/>
                            ';echo' <img class="ico_PostResp" onclick="Likedone(0,\'#unlike'.$cnt.'\','.$post_id.','.$cnt.',2,this,'.$pers_unlike.')" id="un_2_like'.$cnt.'" src="icons/post-sf-unliked.png" style="display:none;" alt="Unlike"/><span class="pers_unlike'.$cnt.'" id="mainunLikecnt_'.$cnt.'">'.$pers_unlike.'</span> 
                            ';
       ...
       $(\'.sf-commentInput\').keyup(function(event)
       {
             ...
             $(\'#submit_post_cmnt'.$cnt.'\').click();
	              ...
	              <div class="newCommentHolder">
                            <span class="commentTitle" id="commentTitle'.$cnt.'" title="Click to view All Comments" onclick="viewprecmnt(\'#previousComments'.$tot_cnt.'\','.$post_id.','.$tot_cnt.')">Comments &nbsp;&nbsp;&nbsp;<img style="width: 10px;height:10px;" src="icons/expnd-dwn.png" alt="down"/></span><span style="display:none" id="refresh_cmnt'.$cnt.'" onclick="refresh_cmnt('.$post_id.',\'#previousComments'.$tot_cnt.'\',\''.$tot_cnt.'\')">New</span>
...
$ratc=0;
	     ...
	     $seen_cnt=0;
             ...
             }else
             {
                    ...
                    $aps="SELECT post_id as pid,user_id as uid,allpeople as ap,allrelation as alr,share as shr,page_id as p,officiale as of_cl,me as ni from post_permision where allpeople=$allppl and  ( allrelation=$allrel or me=1 ) order by post_id desc";
